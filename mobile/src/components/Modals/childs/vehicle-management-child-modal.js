...
import {assurance, defaultImage, technical, vignette} from "../../../constants/images";
    ...
    return (
        <View style={{flex: 1}}>
            ...
            >
              ...
              activeOpacity={.9}
          />
                <View style={{flex: .85, backgroundColor: colors.white}}>
                    <ScrollView>
                        <View style={{
                        ...
                        <View style={{padding: sizes.padding}}>
                            ...
                            <FormInput
                                ...
                                style={{backgroundColor: colors.light, borderRadius: sizes.radius}}
                            />
                            <FormInput
                                name="marque"
                                placeholder="Marque"
                            ...
                            />
                            <View style={{flexDirection: "row", alignItems: "center", backgroundColor: colors.light, height: sizes.inputHeight, borderRadius: sizes.radius}}>
                                <FormCheckbox
                                    name="air_conditioner"
                                    title={"Air Conditioner"}
                                    style={{fontFamily: "latoRegular", fontSize: sizes.h6, marginBottom: 0}}
                                />
                                <AppText>  </AppText>
                                <FormCheckbox
                                    name="heating"
                ...
                <View style={styles.footer}>
                    <SubmitButton
                        title={"submit"}
                        style={{width: "40%", backgroundColor: colors.success, marginVertical: 0}}
                    />
                    <BasicButton
                        title={"cancel"}
                        onPress={() => onCancel()}
                        style={{width: "40%", backgroundColor: colors.danger, marginVertical: 0}}
                    />
                </View>
            </Form>
        </View>
