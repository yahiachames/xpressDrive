      ...
      if (result1.length == 0)
        ...
        const ride = {
          ...
          total_price: req.body.total_price
            ...
            : total_price,
          ratio_per_km: req.body.ratio_per_km
            ? req.body.ratio_per_km
            : ratio_per_km,
          distance_per_km: req.body.distance_per_km
            ? req.body.distance_per_km
            : distance_per_km,
          region: req.body.region ? req.body.region : region,
          sub_region: req.body.sub_region ? req.body.sub_region : sub_region,
          street: req.body.street ? req.body.street : street,
          status: req.body.status ? req.body.status : status,
          timestamp: req.body.timestamp ? req.body.timestamp : timestamp,
          start_by_driver: req.body.start_by_driver
            ? req.body.start_by_driver
            : start_by_driver,
          start_by_rider: req.body.start_by_rider
            ? req.body.start_by_rider
            : start_by_rider,
          completed_by_driver: req.body.completed_by_driver
            ? req.body.completed_by_driver
            : completed_by_driver,
          completed_by_rider: req.body.completed_by_rider
            ? req.body.completed_by_rider
            : completed_by_rider,
          done: req.body.done ? req.body.done : done,
        };

        Ride.findByIdAndUpdate(req.params.id, ride, (error, result) => {
